...
plt.subplot(2, 2, 1)
plt.plot(0.2159574468085107, -0.4183486238532109,'o',color='springgreen')
...
plt.subplot(2, 2, 2)
plt.plot(0.2424028268551235, -0.47339449541284384,'o',color='deepskyblue')
...
plt.subplot(2, 2, 3)
plt.plot(0.28678183356106446, -0.5614678899082566,'o',color='mediumpurple')
...
plt.subplot(2, 2, 4)
plt.plot(0.32878684364630084, -0.6550458715596326,'o',color='hotpink')
