...
# Load 8/17/2022
data_817 = np.loadtxt('/Users/elizabeth/egregorio@gwmail.gwu.edu - Google Drive/My Drive/Box Sync/dataAnalysis/dimensionalData/08172022_data')
...
time_817 = data_817[:,0] * fall_shape
x_817_std = data_817[:,2]# / fall_bl
x_817_std = x_817_std# - x_918_std[0]
std_817 = x_817_std
x_817_mean = data_817[:,1]# / fall_bl
x_817_mean = x_817_mean - x_817_mean[0]
x_817_mean[0] = 0
...
switch_H17 = np.argmin(x_817_mean)
switch_H10 = np.argmin(x_1026_mean)

x_array = [x_1021_mean,x_918_mean,x_920_mean,x_921_mean,x_817_mean,x_1026_mean]
std_array = [std_1021,std_918,std_920,std_921,std_817,std_1026]
max_array = [switch_H28, switch_S3, switch_S2, switch_S1, switch_H17, switch_H10]
angle_array = [x_1021_mean,x_918_mean,x_920_mean,x_921_mean,x_817_mean,x_1026_mean]
std_angle = [std_1021,std_918,std_920,std_921,std_817,std_1026]
...
angle_817  = angle_array[4] * ( 180 / np.pi )
angle_1026 = angle_array[5] * ( 180 / np.pi )
...
std_817  = std_angle[4] * ( 180 / np.pi )
std_1026 = std_angle[5] * ( 180 / np.pi )
...
angle_817[switch_H17:] = 180 - angle_817[switch_H17:]
...
plt.figure()
plt.errorbar(time_817,angle_817,yerr=std_817,linestyle='-',fmt='firebrick',ecolor='mistyrose',elinewidth=3,label='W17')
...
nonD_H17 = data_817[:,0] * H17_pinch_off

# Plot for the STD in Y direction
plt.figure()
plt.errorbar(nonD_H17,angle_817,yerr=std_817,linestyle='-',fmt='firebrick',ecolor='mistyrose',elinewidth=3,label='W17')
...
nonD_H17 = time_817 / H17_time_to_turn
