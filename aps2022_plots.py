...
data_T136 = np.loadtxt('/Users/elizabeth/Box Sync/dataAnalysis/dimensionalData/9182021_data')
data_T153 = np.loadtxt('/Users/elizabeth/Box Sync/dataAnalysis/dimensionalData/9212021_data')
data_H10 = np.loadtxt('/Users/elizabeth/Box Sync/dataAnalysis/dimensionalData/10262021_data')
data_H22 = np.loadtxt('/Users/elizabeth/Box Sync/dataAnalysis/dimensionalData/9202021_data')
data_H28 = np.loadtxt('/Users/elizabeth/Box Sync/dataAnalysis/dimensionalData/10212021_data')
# Import data from 04/04, no hinge, no hole
data_F22 = np.loadtxt('/Users/elizabeth/Box Sync/dataAnalysis/dimensionalData/04042022_data')
data_F10 = np.loadtxt('/Users/elizabeth/Box Sync/dataAnalysis/dimensionalData/04052022_a1_data')
data_F28 = np.loadtxt('/Users/elizabeth/Box Sync/dataAnalysis/dimensionalData/04052022_a3_data')
...
plt.xlim(0,2)
plt.ylim(-2,0)
plt.savefig('/Users/elizabeth/Box Sync/air cavity analysis/paper_cavity_visualization/all_trials/trajectory.png')#_error.png')
...
plt.xlabel('Non-Dimensional Time ( t * v / l )')
plt.ylabel('Depth (Arm Lengths)')
plt.errorbar(time_T136,mean_T136,yerr=std_T136,linestyle='-',fmt='mediumorchid',ecolor='thistle',elinewidth=3,label='0.0768Nm')
...
plt.xlim(0,2)
plt.ylim(-2,0)
plt.savefig('/Users/elizabeth/Box Sync/air cavity analysis/paper_cavity_visualization/all_trials/stiffness_trajectory.png')#_error.png')
#plt.savefig('/Users/elizabeth/Box Sync/air cavity analysis/paper_cavity_visualization/all_trials/stiffness_136.png')#_error.png')
